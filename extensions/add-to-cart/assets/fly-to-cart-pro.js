...
// Listens for add-to-cart events and triggers animations
...
class FlyToCartPro {
  ...
  getScriptUrl() {
    const scripts = document.querySelectorAll('script[src*="fly-to-cart-pro"]');
